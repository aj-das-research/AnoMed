...
from data.loaders import get_val_dataloader
from utils.metrics import calculate_ap50, calculate_ap50_95

def validate_model(dataloader, config):
    ...
    with torch.no_grad():
        ...
        print(f"Validation AP50: {avg_ap50}, AP50:95: {avg_ap50_95}")
...
if __name__ == "__main__":
    ...
    validate_model(val_dataloader, config)
